...
#' @param criterionscoring criterion to use
#'
...
hector_126 <- scored_hector_runs(ini_126, 50, my_metric, criterion_co2_obs())
hector_126$ssp <- rep("ssp126")
hector_245 <- scored_hector_runs(ini_245, 50, my_metric, criterion_co2_obs())
hector_245$ssp <- rep("ssp245")
hector_370 <- scored_hector_runs(ini_370, 50, my_metric, criterion_co2_obs())
hector_370$ssp <- rep("ssp370")
hector_585 <- scored_hector_runs(ini_585, 50, my_metric, criterion_co2_obs())
