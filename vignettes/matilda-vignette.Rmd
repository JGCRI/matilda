...
As a final simple analysis example, we will show how these functions give Hector the capability to be used as a coupled climate model to compute probabilistic projections of future climate change using emissions derived from commonly used Shared Socio-economic Pathways (SSPs).
